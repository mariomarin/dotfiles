...
# Bitwarden - only load if enabled and bw is available
# The module itself is safe to load; commands check for bw at runtime
use ($nu.default-config-dir | path join 'modules' 'bitwarden') *
